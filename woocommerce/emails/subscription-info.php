	...
	<?php foreach ( $subscriptions as $subscription ) : ?>
		...
		<tr>
			...
			<td class="td" scope="row" style="text-align:left;">
				...
				<?php // HC CHANGE: Added $_hc_is_prepaid check — suppress "Next payment" for prepaid subscriptions (already paid upfront).
				$_hc_is_prepaid = (bool) $subscription->get_meta( '_ps_prepaid_pieces' );
				if ( $is_parent_order && ! $_hc_is_prepaid && $subscription->get_time( 'next_payment' ) > 0 ) : ?>
					<br>
